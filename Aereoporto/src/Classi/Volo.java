...
public class Volo {
	...
	public String toString() {
		return "Volo [codiceVolo=" + codiceVolo + ", cittaPartenza=" + cittaPartenza + ", cittaArrivo=" + cittaArrivo
				+ ", dataPartenza=" + dataPartenza + ", dataArrivo=" + dataArrivo + ", orarioPartenza=" + orarioPartenza
				+ ", orarioArrivo=" + orarioArrivo + ", numeroPrenotazioni=" + numeroPrenotazioni + "]";
	}
