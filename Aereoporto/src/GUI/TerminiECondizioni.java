	...
	public TerminiECondizioni(Controller controller) {
		...
		lblAnnulla.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				controllerTerminiECondizioni.cambioImmagineTema(lblAnnulla, img.tornaIndietro2TemaChiaro(),
						img.tornaIndietro2());
			}

			@Override
			public void mouseExited(MouseEvent e) {
				controllerTerminiECondizioni.cambioImmagineTema(lblAnnulla, img.tornaIndietro1TemaChiaro(),
						img.tornaIndietro1());
			}

			@Override
			public void mousePressed(MouseEvent e) {
				controllerTerminiECondizioni.cambioImmagineTema(lblAnnulla, img.tornaIndietro3TemaChiaro(),
						img.tornaIndietro3());
			}
		...
		lblLayout.setIcon(new ImageIcon(img.sfondoTerminiECondizioni()));
		lblLayout.setBounds(0, 0, 450, 642);
