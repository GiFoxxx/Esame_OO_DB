...
public class Immagini {
	...
	public Image lineeChiusuraTemaChiaro() {
		Image lineeChiusura = new ImageIcon(
				Accesso.class.getResource("immaginiDashboardChiare/lineeChiusuraChiare.png")).getImage()
						.getScaledInstance(25, 15, Image.SCALE_SMOOTH);
		return lineeChiusura;
	}

	public Image lineeAperturaTemaChiaro() {
		Image lineeApertura = new ImageIcon(
				Accesso.class.getResource("immaginiDashboardChiare/lineeAperturaChiare.png")).getImage()
						.getScaledInstance(25, 15, Image.SCALE_SMOOTH);
		return lineeApertura;
	}
	...
	public Image accedi1() {
		Image accedi1 = new ImageIcon(SceltaProfiloSenzaAccesso.class.getResource("immaginiBottoni/accedi1.png"))
				.getImage().getScaledInstance(135, 41, Image.SCALE_SMOOTH);
		return accedi1;
	}
	...
	// SI
	public Image si1() {
		Image si1 = new ImageIcon(Uscita.class.getResource("immaginiBottoni/si1.png")).getImage().getScaledInstance(135,
				41, Image.SCALE_SMOOTH);
		return si1;
	}

	public Image si2() {
		Image si2 = new ImageIcon(Uscita.class.getResource("immaginiBottoni/si2.png")).getImage().getScaledInstance(135,
				41, Image.SCALE_SMOOTH);
		return si2;
	}

	public Image si3() {
		Image si3 = new ImageIcon(Uscita.class.getResource("immaginiBottoni/si3.png")).getImage().getScaledInstance(135,
				41, Image.SCALE_SMOOTH);
		return si3;
	}
